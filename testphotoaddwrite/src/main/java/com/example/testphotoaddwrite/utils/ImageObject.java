...
public class ImageObject
{
	...
	public void drawIcon(Canvas canvas)
	{
		...
		canvas.drawBitmap(deleteBm, deletePF.x - deleteBm.getWidth() / 2-10,
				deletePF.y - deleteBm.getHeight() / 2-10, paint);
		PointF rotatePF = getPointRightBottom();
		canvas.drawBitmap(rotateBm, rotatePF.x - rotateBm.getWidth() / 2+10,
				rotatePF.y - rotateBm.getHeight() / 2+10, paint);
	}
